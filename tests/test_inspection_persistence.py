...
def test_current_inspection_version_is_eleven_for_optional_size_duplicate_variant():
    # 같은 CSV가 버전 10 결과를 재사용해 BAG 빈 size 옵션 중복 검사를 건너뛰지 않도록 고정합니다.
    assert INSPECTION_VERSION == "11"
