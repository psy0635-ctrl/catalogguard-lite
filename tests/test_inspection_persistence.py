...
def test_current_inspection_version_is_ten_for_optional_size_duplicate_content():
    # 같은 CSV가 버전 9 결과를 재사용해 BAG 빈 size 완전 중복 검사를 건너뛰지 않도록 고정합니다.
    assert INSPECTION_VERSION == "10"
