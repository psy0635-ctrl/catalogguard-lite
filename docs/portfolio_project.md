...
| 최신 로컬 테스트 결과 | 791 passed, 25 skipped, 0 failed |
...
```text
791 passed, 25 skipped, 0 failed
```
...
CI는 테스트 전에 `20260703_0001`, `20260705_0002` Alembic 마이그레이션을 적용합니다. 이번 로컬 검증 결과는 `791 passed, 25 skipped`이며, CI의 실제 테스트 개수는 각 GitHub Actions 실행 결과에서 별도로 확인합니다.
